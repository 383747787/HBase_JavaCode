...
//Program to insert one row in Hbase table
//Query - Put '<tablename>', <rowid>, '<ColumnFamily>:<ColumnName>', '<Value>'
public class singlePut{
    ...
    public static void main(String[] args) throws IOException{
        ...
        put.addColumn(Bytes.toBytes("attributes"),Bytes.toBytes("for_user"),Bytes.toBytes("Bhaskar"));
